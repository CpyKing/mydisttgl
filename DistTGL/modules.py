...
"""Network Structure
GeneralModel(
  (memory_updater): SmartMemoryUpdater(
    (updater): GRUCell(300, 100)
    (time_enc): TimeEncode(
  ...
  (layers): ModuleDict(
    (l0h0): TransfomerAttentionLayer(
      ...
      (w_k): Linear(in_features=200, out_features=100, bias=True)
      (w_v): Linear(in_features=200, out_features=100, bias=True)
