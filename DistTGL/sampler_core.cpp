                    ...
                    for (std::vector<NodeIDType>::size_type j = 0; j < (*root_nodes).size(); j++)
                    {
                        ...
                        else
                        {
                            ...
                            if (num_history == 1)
                            {
                                ...
                                // std::cout << s_search << " " << int(e_it - ts.begin()) << " " << e_search << std::endl;
                            }
                            else
                            {
                                // DySAT style
                        ...
                        {                            
                            ...
                            {
                                // std::cout << "pick recent neighbor" << std::endl;
                                // std::cout << e_search - std::max(s_search, e_search - neighs) << std::endl;
                                // std::cout << k << std::endl;
                                // std::cout << nts + offset - 1e-7f << std::endl;
